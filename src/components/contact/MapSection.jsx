...
export function MapSection({ mapQuery, address = CONTACT_INFO.address }) {
  const query = mapQuery || "Sharda+Academy+Delhi";
  const mapUrl = `https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d901.4!2d72.9289514!3d19.0514193!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c724867cc043%3A0x3aac9bf792d9f1ba!2s${query}!5e0!3m2!1sen!2sin!4v1687000000000`;

  return (
    <section className="w-full bg-surface relative z-0">
      <div className="container mx-auto px-4 py-20">
        <Fade>
          <div className="w-full h-[500px] md:h-[600px] bg-muted relative rounded-xl overflow-hidden border border-border-color/50 shadow-2xl">
          ...
          <div className="absolute bottom-8 left-4 right-4 md:left-12 md:right-auto md:w-96 bg-white/95 dark:bg-surface/95 backdrop-blur-md border border-border shadow-2xl rounded-xl p-6 z-10">
