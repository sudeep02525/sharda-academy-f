            ...
            <Fade direction="right" delay={0.1}>
              <div>
                ...
                <p className="text-paragraph leading-relaxed">
                  Students currently studying in classes 8, 9, 10, 11, or 12 are eligible to apply. For JEE and NEET repeater batches, 12th pass students can apply directly. Minimum 60% aggregate in the previous academic year is required for direct admission.
                </p>
              </div>
            </Fade>
            ...
            <Fade direction="right" delay={0.2}>
              <div>
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-heading">Scholarship Details</h3>
                </div>
                <p className="text-paragraph leading-relaxed mb-4">
                  We reward merit. Our Sharda Talent Search Exam (STSE) provides substantial financial aid based on performance:
                </p>
                <ul className="space-y-2">
                  <li className="flex justify-between items-center bg-card border border-border px-4 py-2 rounded-lg text-sm font-semibold text-heading"><span>Top 10 Rankers</span> <span className="text-primary">100% Scholarship</span></li>
                  <li className="flex justify-between items-center bg-card border border-border px-4 py-2 rounded-lg text-sm font-semibold text-heading"><span>Rank 11 - 50</span> <span className="text-primary">75% Scholarship</span></li>
                  <li className="flex justify-between items-center bg-card border border-border px-4 py-2 rounded-lg text-sm font-semibold text-heading"><span>Rank 51 - 100</span> <span className="text-primary">50% Scholarship</span></li>
                </ul>
              </div>
            </Fade>
