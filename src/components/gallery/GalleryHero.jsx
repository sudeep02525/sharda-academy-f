...
export function GalleryHero({ data }) {
  const heroData = data || { badge: "Gallery", title: "Campus Life", description: "Take a visual tour of our facilities" };
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          <Fade direction="up" delay={0.4}>
            <p className="text-lg md:text-xl text-paragraph leading-relaxed max-w-2xl mx-auto font-medium">
