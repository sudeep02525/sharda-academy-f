...
const DEFAULT_DATA = {
  sections: [
    { id: "1", title: "1. Introduction", icon: "FileText", content: "Welcome to Sharda Academy. We respect your privacy..." }
  ]
};
  ...
  return (
    <PageContainer>
      <div className="flex flex-col lg:flex-row gap-6 mb-8 items-start lg:items-center justify-between animate-fade-in-up">
        <div>
          <h1 className="text-2xl font-black text-navy uppercase tracking-tight">Manage Privacy Policy</h1>
          <p className="text-xs font-bold text-slate-400 mt-1 uppercase tracking-wider">
            Edit the sections of your Privacy Policy page
          </p>
        </div>
      ...
      {showToast && (
        <div className="fixed top-20 right-4 z-[9999] animate-fade-in-up flex items-center gap-3 bg-white border border-green-200 shadow-xl rounded-xl p-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 font-medium">Privacy policy updated.</p>
          </div>
        </div>
      )}
