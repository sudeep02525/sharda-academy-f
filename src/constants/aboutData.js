...
export const MISSION_VISION_DATA = {
  mission: {
    title: "Our Mission",
    description: "To deliver accessible, high-quality coaching that empowers students to build a strong foundation and conquer competitive examinations with confidence.",
    icon: "Target"
  },
  vision: {
    title: "Our Vision",
    description: "To be the most trusted coaching academy in the region, known for our student-first approach, expert faculty, and consistent board and entrance exam results.",
    icon: "Eye"
  }
};

export const DIRECTOR_MESSAGE_DATA = {
...
export const WHY_PARENTS_CHOOSE_US_DATA = {
