...
export default function TrustLogosEditor() {
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-lg font-black text-navy uppercase tracking-tight">Trust Indicators Editor</h2>
        ...
        {items.map((item, i) => (
          <div key={i} className="flex flex-col sm:flex-row items-center gap-4 p-4 bg-slate-50 rounded-xl border border-slate-200">
            ...
            <div className="w-full sm:w-1/2">
              ...
              <input type="text" className="w-full px-3 py-2 rounded-lg border border-slate-200 text-sm" defaultValue={item.label} />
            </div>
